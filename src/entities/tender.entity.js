...
(function (TenderStatus) {
    ...
    TenderStatus["ARCHIVED"] = "archived";
 ...
 */
let Tender = (() => {
    let _classDecorators = [Entity('tenders')];
    ...
    var Tender = class {
        ...
        static {
            ...
            _reference_decorators = [Column({ unique: true })];
            ...
            _deadline_decorators = [Column({ type: 'timestamp' })];
            _fileUrl_decorators = [Column({ nullable: true })];
            _organization_decorators = [Column({ nullable: true })];
            ...
            Tender = _classThis = _classDescriptor.value;
        ...
        category = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _category_initializers, void 0)); // ex: Construction, Fournitures, Services
        ...
        fileUrl = (__runInitializers(this, _deadline_extraInitializers), __runInitializers(this, _fileUrl_initializers, void 0)); // URL du document d'appel d'offres
        organization = (__runInitializers(this, _fileUrl_extraInitializers), __runInitializers(this, _organization_initializers, void 0)); // Si différent de APC
        createdAt = (__runInitializers(this, _organization_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
        updatedAt = (__runInitializers(this, _createdAt_extraInitializers), __runInitializers(this, _updatedAt_initializers, void 0));
        constructor() {
            __runInitializers(this, _updatedAt_extraInitializers);
        }
    };
    return Tender = _classThis;
})();
export { Tender };
