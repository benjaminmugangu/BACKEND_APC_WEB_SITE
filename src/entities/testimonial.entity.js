...
export var TestimonialStatus;
(function (TestimonialStatus) {
    TestimonialStatus["DRAFT"] = "draft";
    TestimonialStatus["PUBLISHED"] = "published";
 ...
 *           type: integer
 */
let BeneficiaryTestimonial = (() => {
    let _classDecorators = [Entity('beneficiary_testimonials')];
    ...
    var BeneficiaryTestimonial = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _id_decorators = [PrimaryGeneratedColumn('uuid')];
            _authorName_decorators = [Column()];
            _authorRole_decorators = [Column({ nullable: true })];
            _authorLocation_decorators = [Column({ nullable: true })];
            _photoUrl_decorators = [Column({ nullable: true })];
            _content_decorators = [Column('text')];
            _projectName_decorators = [Column({ nullable: true })];
            ...
            BeneficiaryTestimonial = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        id = __runInitializers(this, _id_initializers, void 0);
        authorName = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _authorName_initializers, void 0));
        authorRole = (__runInitializers(this, _authorName_extraInitializers), __runInitializers(this, _authorRole_initializers, void 0)); // Ex: "Agriculteur", "Mère de famille", "Jeune bénéficiaire"
        authorLocation = (__runInitializers(this, _authorRole_extraInitializers), __runInitializers(this, _authorLocation_initializers, void 0)); // Ex: "Bukavu, Sud-Kivu"
        ...
        projectName = (__runInitializers(this, _content_extraInitializers), __runInitializers(this, _projectName_initializers, void 0)); // Projet associé au témoignage
    ...
    return BeneficiaryTestimonial = _classThis;
})();
export { BeneficiaryTestimonial };
