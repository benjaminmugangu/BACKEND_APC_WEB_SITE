 ...
 */
let MessageSubject = (() => {
    let _classDecorators = [Entity('message_subjects')];
    ...
    var MessageSubject = class {
        ...
        static {
            ...
            MessageSubject = _classThis = _classDescriptor.value;
        ...
        messages = (__runInitializers(this, _order_extraInitializers), __runInitializers(this, _messages_initializers, void 0));
    ...
    return MessageSubject = _classThis;
})();
