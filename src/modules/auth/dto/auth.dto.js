...
let LoginDto = (() => {
    ...
    return class LoginDto {
        static {
            ...
            _email_decorators = [IsEmail({}, { message: 'Email invalide' }), IsNotEmpty({ message: "L'email est requis" })];
            _password_decorators = [IsNotEmpty({ message: 'Le mot de passe est requis' })];
