...
let CreateMessageSubjectDto = (() => {
    ...
    return class CreateMessageSubjectDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [IsString(), IsNotEmpty()];
            _nameEn_decorators = [IsString(), IsOptional()];
            _isActive_decorators = [IsBoolean(), IsOptional()];
            _order_decorators = [IsNumber(), IsOptional()];
...
export { CreateMessageSubjectDto };
let UpdateMessageSubjectDto = (() => {
    let _name_decorators;
    let _name_initializers = [];
    let _name_extraInitializers = [];
    let _nameEn_decorators;
    ...
    let _order_initializers = [];
    let _order_extraInitializers = [];
    return class UpdateMessageSubjectDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
...
export { UpdateMessageSubjectDto };
