...
let CreateNewsCategoryDto = (() => {
    ...
    return class CreateNewsCategoryDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [IsString(), IsNotEmpty({ message: 'Le nom de la catégorie est requis' })];
...
export { CreateNewsCategoryDto };
let UpdateNewsCategoryDto = (() => {
    let _name_decorators;
    let _name_initializers = [];
    let _name_extraInitializers = [];
    let _slug_decorators;
    ...
    let _isActive_initializers = [];
    let _isActive_extraInitializers = [];
    return class UpdateNewsCategoryDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
