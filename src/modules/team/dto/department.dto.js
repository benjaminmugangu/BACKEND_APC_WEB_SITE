...
let CreateDepartmentDto = (() => {
    ...
    return class CreateDepartmentDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [IsString(), IsNotEmpty({ message: 'Le nom du département est requis' })];
        ...
        order = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _order_initializers, void 0));
...
let UpdateDepartmentDto = (() => {
    ...
    let _isActive_initializers = [];
    let _isActive_extraInitializers = [];
    return class UpdateDepartmentDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [IsOptional(), IsString(), IsNotEmpty()];
            _description_decorators = [IsOptional(), IsString()];
            _order_decorators = [IsOptional(), IsNumber()];
            _isActive_decorators = [IsOptional(), IsBoolean()];
            __esDecorate(null, null, _name_decorators, { kind: "field", name: "name", static: false, private: false, access: { has: obj => "name" in obj, get: obj => obj.name, set: (obj, value) => { obj.name = value; } }, metadata: _metadata }, _name_initializers, _name_extraInitializers);
