...
router.get('/:id', async (req, res, next) => {
    try {
        const department = await service.findOne(req.params.id);
...
router.post('/', validationMiddleware(CreateDepartmentDto), async (req, res, next) => {
    try {
...
router.put('/:id', validationMiddleware(UpdateDepartmentDto), async (req, res, next) => {
    try {
...
router.patch('/:id/toggle', async (req, res, next) => {
    try {
        const department = await service.toggleActive(req.params.id);
